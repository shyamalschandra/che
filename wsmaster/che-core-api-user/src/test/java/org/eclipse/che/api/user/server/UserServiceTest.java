...
public class UserServiceTest {
    ...
    public void initService() {
        ...
        userService = new UserService(userManager, tokenValidator, linksInjector, true);
    }

    @Test
    public void shouldCreateUserFromToken() throws Exception {
        when(tokenValidator.validateToken("token_value")).thenReturn("test@codenvy.com");
    ...
    @Test
    public void shouldNotCreateUserFromTokenIfSelfCreationIsNotAllowed() throws Exception {
        userService = new UserService(userManager, tokenValidator, linksInjector, false);
        ...
        assertEquals(unwrapError(response), "User self creation is not allowed");
    }
